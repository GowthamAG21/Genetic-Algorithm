...
<body>
	...
	<div class="">
		<ul id="nav">
			<li class="current"><a onclick="loadHomePage()">Home</a></li>
			<li><a onclick="searchVehicle()">Search vehicle</a></li>
			<li><a onclick="underConstruction()">Result</a></li>
			<li><a href="http://localhost:8080/GeneticAlgorithm/index.jsp">Logout</a></li>
			<li><a id=user_name">Welcome</a></li>
		</ul>
	</div>
	<div style="height: 10px;"></div>
	<table width="100%" height="100%">
		<tr style="width: 100%">
			<td valign="top" style="width: 16%"><img 
			alt=""
			class="img-thumbnail"	style="width: 200px; height: 200px; margin-top: 15px"
				src="../images/No_person.jpg"></td>
			<td valign="top" id="Mainblock" style="width: 80%"></td>
